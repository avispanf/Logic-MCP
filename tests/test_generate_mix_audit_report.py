...
class ConsolidatedReportTests(unittest.TestCase):
    def test_combines_continuation_and_plugin_results(self):
        ...
        rows = [
            ...
            {"event": "step_finished", "summary": {"step_id": f"target-001-{target_id}-plugin-00-open", "operation": "plugin_open_insert", "target_id": target_id, "ok": True}, "result": {"plugin": "Pro-Q", "identity": {"plugin": "Pro-Q 3"}}},
        ...
        self.assertEqual(result["targets"][0]["plugins"][0]["name"], "Pro-Q 3")
        self.assertEqual(
