...
class ConsolidatedReportTests(unittest.TestCase):
    def test_combines_continuation_and_plugin_results(self):
        ...
        rows = [
            ...
            {"event": "step_finished", "summary": {"step_id": f"target-001-{target_id}-plugin-00-parameters", "operation": "plugin_parameters", "target_id": target_id, "parameter_count": 320}, "result": {}},
